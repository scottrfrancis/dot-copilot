...
- **Goal-Driven Execution** (tests-first, verify-then-loop) — see `testing.instructions.md`; a mandatory RED-GREEN-REFACTOR rule is stronger than Karpathy's "consider tests-first" framing.
