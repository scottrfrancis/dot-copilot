---
description: "Architecture Decision Record format: one canonical ADR convention — location, numbering, status lifecycle, and spec-driven traceability links"
applyTo: "**/docs/decisions/**,**/docs/adr/**,**/ADR-*.md,**/adr-*.md"
---
