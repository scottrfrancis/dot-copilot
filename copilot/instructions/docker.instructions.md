---
description: "Dockerfile and docker-compose standards: multi-stage builds, security, layer optimization"
applyTo: "**/Dockerfile*,**/*.dockerfile,**/docker-compose*.yml,**/compose*.yml"
---
